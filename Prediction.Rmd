...
#Data Cleaning
To clean the data, the first row index and all colomuns with NA were removed. The traing and testing data were saved as traing2.csv and testing2.csv# Remove everything in current working library
```{r}
rm(list = ls())
